...
/* copy from CCITT G.711 specifications */
  static const /*unsigned char*/ _u2a = [
...
/* corrected:
  ...
  static const /*unsigned char*/ _a2u = [
...
/* corrected:
  ...
  static /*short*/ int search(/*short*/ int val, /*short* */ List<int> table) {
 ...
 *
 */
/*short*/ static int alaw2linear(/*unsigned char*/ int a_val) {
    /*short*/ int t;
    /*short*/ final int seg;
...
* John Wiley & Sons, pps 98-111 and 472-476.
*/
/*unsigned char*/ static int linear2ulaw(
      /*short*/ int pcm_val) /* 2's complement (16-bit range) */
  {
    /*short*/ final int mask;
    /*short*/ final int seg;
 ...
 */
/*short*/ static int ulaw2linear(/*unsigned char*/ int u_val) {
    /*short*/ int t;
...
/*unsigned char*/ static int alaw2ulaw(/*unsigned char*/ int aval) {
    aval &= 0xff;
    return /*(unsigned char)*/ ((aval & 0x80) != 0
        ? (0xFF ^ _a2u[aval ^ 0xD5])
        : (0x7F ^ _a2u[aval ^ 0x55]));
  }

/* u-law to A-law conversion */
/*unsigned char*/ static int ulaw2alaw(/*unsigned char*/ int uval) {
    uval &= 0xff;
    return /*(unsigned char)*/ ((uval & 0x80) != 0
